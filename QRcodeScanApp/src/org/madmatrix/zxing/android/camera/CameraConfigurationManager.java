...
//				.getDefaultSharedPreferences(context);
	...
	private Point findBestPreviewSizeValue(Camera.Parameters parameters,
		...
		/*
		 * if (Log.isLoggable(TAG, Log.INFO)) { StringBuilder previewSizesString
		 * = new StringBuilder(); for (Camera.Size supportedPreviewSize :
		 * supportedPreviewSizes) {
		 * previewSizesString.append(supportedPreviewSize
		 * .width).append('x').append(supportedPreviewSize.height) .append(' ');
